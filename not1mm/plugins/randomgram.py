...
def interface(self):
    ...
    self.other_label.setText(QtWidgets.QApplication.translate("ContestPlugin", "SentRG"))
    self.field3.setAccessibleName("Sent RandomGram")
    self.exch_label.setText(QtWidgets.QApplication.translate("ContestPlugin", "RcvRG"))
