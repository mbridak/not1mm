"""SSA Manadstest CW plugin"""

# SSA Manadstest - Swedish monthly HF contest, CW mode.
#   Exchange:   RST + serial number + 6-character Maidenhead locator
#   Example:    599 01 JP75XX
...
def _check_rst(value, rst_min=111, rst_max=599):
