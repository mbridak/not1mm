...
To edit the macros, choose \textbf{File >> Edit Macros}. This will open your systems registered text editor with current macros loaded. When you're done just save the file and close the editor. The file loaded to edit, CW, SSB or RTTY, will be determined by your current operating mode and contest. Each contest gets it's own copy of the macros.
...
\textbf{Frequency} You can enter a frequency in kilohertz. This will change the band you're logging on. If you have CAT control, this will change the frequency of the radio as well.
\subsection{Modes}
\textbf{CW, SSB, RTTY} You can set the mode logged. If you have CAT control this will also change the mode on the radio.
\subsection{Change Operator}
\textbf{OPON} Change the operator currently logging.\\
\\
\textbf{Again you must press the SPACE bar after entering any of the above.}
